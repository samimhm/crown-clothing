...
const removeCartItem = (cartItems, cartItemToRemove) => {
    const existingCartItem = cartItems.find(item => { return item.id === cartItemToRemove.id})
...
const clearCartItem = (cartItems, cartItemToClear) => {
    const existingCartItem = cartItems.find(item => { return item.id === cartItemToClear.id})
